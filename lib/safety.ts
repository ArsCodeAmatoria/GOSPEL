...
export const SAFETY: SafetySection[] = [
  {
    ...
    intro:
      "KYUK is a complete crane operations and rigging company. Qualified crane operators, riggers, signalpersons, crane supervisors and safety support — competent people on lifting work, to a published standard.",
    blocks: [
      {
        type: "quote",
      ...
      {
        type: "p",
        text: "Proven is the company’s rulebook for lifting work. It applies to every worker KYUK deploys, every supervisor KYUK assigns, and every job we accept. Clients can read it before they hire us. Workers can read it before they accept a dispatch. That is deliberate.",
      },
      {
        type: "h",
        text: "WHAT PROVEN IS",
      },
      {
        type: "list",
        items: [
          "The minimum standard for how KYUK personnel plan, rig, signal and lift.",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            body: "Reliability is a safety control. A missing operator mid-lift is a hazard. If KYUK cannot fill a role, the client is told immediately.",
          },
        ],
      },
      {
      ...
      {
        type: "p",
        text: "KYUK is a complete crane operations and rigging company. The people and the systems. Lifting work is performed in accordance with the following. Where they conflict, the stricter applicable requirement wins. Law always wins. This program is written to sit on top of that stack, not beside it.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "p",
        text: "KYUK operates in Canada. Provincial occupational health and safety statutes, regulations and codes of practice apply on the site where the work is performed.",
      },
    ],
  },
  {
    ...
    intro:
      "Lifting work fails when everybody assumes somebody else has it. KYUK supplies people into workplaces we do not always control. The split in responsibility has to be explicit.",
    blocks: [
      {
        type: "h",
        text: "KYUK",
      },
      {
        ...
        items: [
          ...
          "Investigate incidents involving KYUK personnel and share findings with the client as required.",
        ],
      },
      {
        type: "h",
      ...
      },
      {
        ...
        items: [
          ...
          "Do not direct KYUK personnel to skip this program or applicable law.",
        ],
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "Workers Compensation Act s. 23. A supervisor KYUK sends — or a site supervisor directing our people — ensures the workers under their direct supervision are made aware of known or reasonably foreseeable health and safety hazards, and comply with the Act, the Regulation, and this program as it applies. They consult and cooperate with the joint committee or worker representative where there is one. They cooperate with WorkSafeBC. They do not own the entire site. They do own whether the people they supervise work to the plan.",
      },
      {
        type: "list",
        items: [
      ...
      {
        type: "p",
        text: "When KYUK supplies lift supervision, that person owns the lift sequence: briefing, exclusion zone, communication, stop/start, and the decision to abort. They do not own the entire site. They do own whether the hook moves.",
      },
      {
        type: "quote",
      ...
      {
        type: "p",
        text: "KYUK personnel may have more than one party directing their work. That does not dilute this program. A client instruction that conflicts with this program or with law is not followed. The worker stops, states the conflict, and the lift waits until it is resolved.",
      },
    ],
  },
  {
    ...
    intro:
      "Every KYUK dispatch requires a hazard assessment. A generic form filled in the parking lot is not an assessment. Look at the work. Name the hazards. Control them. Then lift.",
    blocks: [
      {
        type: "steps",
        items: [
  ...
  },
  {
    ...
    intro:
      "Safe Work Procedures (SWPs) cover types of work KYUK personnel perform repeatedly. They are written as sequences because lifting is a sequence. Read them in order. Do them in order. Hazards for that work are in the JHA — not buried in the procedure.",
    blocks: [
      {
        type: "p",
        text: "SWPs live in this program so they can be read on a phone at the gate. They are the default method. A site may impose a stricter method. A site may not impose a looser one on KYUK personnel.",
      },
      {
        type: "cta",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        label: "FILL THIS CYCLE — KYUK-FRM-052 →",
      },
      {
        type: "cta",
        href: "/safety/builder/loading-platform-sjp",
        label: "FILL THIS DECK — KYUK-FRM-053 →",
      },
      {
        type: "cta",
      ...
      },
      {
        ...
        items: [
          ...
          "Flytable / flyform cycles — every table, every floor. KYUK-SJP-001. Corner and nontypical tables: KYUK-SJP-002.",
          "Loading-platform install, reposition or strike — every deck, every floor. KYUK-SJP-003. Daily SuperDeck extend / retract is host, not this SJP.",
  ...
  },
  {
    ...
    intro:
      "KYUK riggers rig to rated capacity, known weights and inspected hardware. We do not “make it work” with a choker and optimism. Rigging is done to ASME B30, manufacturer instructions for the hardware, and the site.",
    blocks: [
      {
        type: "h",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "p",
        text: "Treat as critical unless the site defines a stricter threshold: loads approaching chart capacity, tandem lifts, lifts over operating plant or public space, non-routine paths, loads with shifting COG, a flytable / flyform cycle, or a loading-platform install, reposition or strike. Critical lifts get an SJP, named supervision, and a slower brief. Ego is not a control. Flytables: KYUK-SWP-028, KYUK-JHA-011, KYUK-SJP-001. Loading platforms: KYUK-SWP-030, KYUK-JHA-014, KYUK-SJP-003.",
      },
      {
        type: "cta",
        href: "/safety/swp/flytable-cycling",
        label: "FLYTABLE CYCLING — KYUK-SWP-028 →",
      },
      {
        type: "cta",
        href: "/safety/swp/loading-platform-reposition",
        label: "LOADING PLATFORM — KYUK-SWP-030 →",
      },
      {
        type: "h",
      ...
      },
      {
        ...
        label: "WEATHER AND WIND — KYUK-SWP-023 →",
      },
      {
        type: "p",
      ...
      },
      {
        ...
        label: "WORKING NEAR POWERLINES — KYUK-SWP-018 →",
      },
      {
        type: "h",
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "Bullying or harassment toward a KYUK worker — including on a client site.",
        ],
      },
      {
        type: "h",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            n: "04",
            title: "NOTIFY",
            body: "Site supervision, KYUK, and the regulator when the law requires it. Immediate for serious events — not after the shift beer.",
          },
          {
            n: "05",
            title: "WRITE IT DOWN",
          ...
          },
          {
            ...
            body: "KYUK investigates events involving our people. Collect facts, photographs, gear, witness names. Name causes and contributing factors — not a defence brief. Corrective actions get owners and dates. Close them. The program is updated when the lesson is real. KYUK-FRM-013.",
          },
        ],
      },
      {
        ...
        label: "INVESTIGATION — KYUK-FRM-013 →",
      },
      {
        type: "cta",
        href: "/safety/form/refuse-unsafe-work",
        label: "REFUSAL OF UNSAFE WORK — KYUK-FRM-035 →",
      },
      {
        type: "quote",
  ...
  },
  {
    ...
    intro:
      "Every dispatch needs to know how the site calls for help. KYUK does not assume the client’s emergency plan is obvious. We ask. Then we brief it.",
    blocks: [
      {
        type: "h",
      ...
      },
      {
        ...
        items: [
          ...
          "Contact for KYUK after hours.",
        ],
      },
      {
        type: "p",
        text: "First aid on a host site is the host’s. First aid on a workplace KYUK controls is KYUK’s assessment under Part 3 Division 4. KYUK-POL-025. Drills are recorded where KYUK is the employer at that workplace. KYUK-FRM-034.",
      },
      {
        type: "cta",
        href: "/safety/form/emergency-drill",
        label: "EMERGENCY DRILL — KYUK-FRM-034 →",
      },
      {
        type: "cta",
        href: "/safety/policy/first-aid",
        label: "KYUK-POL-025 — FIRST AID →",
      },
      {
        type: "h",
        ...
        items: [
          {
            ...
            body: "Stop. People first. Land or hold only if it does not create a second event. Notify the site and KYUK. Hold the scene. KYUK-SWP-024.",
          },
          {
          ...
          },
          {
            ...
            body: "Make it safe. First aid. Emergency services. Do not move the person unless they are in immediate danger. Notify KYUK immediately.",
          },
          {
          ...
          },
          {
            ...
            body: "Land the load. Manufacturer shutdown. People off the machine. Thunder: stop, shelter 30 minutes after the last rumble. Do not count to 30. Strike: 14.16.1. KYUK-SWP-023.",
          },
          {
          ...
          {
            title: "Worker rescue",
            body: "Fall arrest rescue is part of the plan before anyone ties off. Suspension trauma is on the clock. Do not improvise a crane-as-rescue unless that operation is permitted and planned. A tower operator in the cab or on the tower is THARRP — fire-department rope rescue, not a KYUK rappel.",
          },
        ],
      },
      {
      ...
      {
        type: "p",
        text: "The Technical High Angle Rope Rescue Program is BCCSA’s. It trains municipal fire departments to get a worker down from a tower crane. It is not a KYUK rope team. It is not a fall-protection plan. G4.13(3)(a) still requires a risk assessment and written rescue procedures for high-angle work.",
      },
      {
        type: "list",
        items: [
          "Before a KYUK tower operator goes up: name the fire department, the summoning method, and where the written plan sits. If nobody can name them, the operator stays on the ground.",
          "The host or prime requests the crane or site survey in the THARRP Portal. KYUK confirms it exists. A tower expected past 60 days on a changing high-rise needs the formal Site Survey & Site Rescue Procedure Review on site — ADM 2.",
  ...
  },
  {
    ...
    intro:
      "KYUK supplies crane and rigging personnel whose qualifications, experience and practical competency have been checked against the work.",
    blocks: [
      {
        type: "quote",
      ...
      {
        type: "p",
        text: "This matrix is the check before dispatch. It is how KYUK matches people to the work.",
      },
      {
        type: "table",
        caption: "KYUK crane and rigging competency — dispatch check. Not a training course.",
  ...
  },
  {
    ...
    intro:
      "Canadian workers have the right to know, the right to participate, and the right to refuse dangerous work. KYUK treats those rights as operating procedure, not HR wallpaper.",
    blocks: [
      {
        type: "h",
        text: "RIGHT TO KNOW",
      ...
      {
        type: "p",
        text: "The Act sets this by workplace, not by a company’s total headcount. Twenty or more workers regularly employed at a workplace: joint committee. Nine to nineteen: worker health and safety representative. KYUK-POL-026. On a host site, KYUK people participate in that workplace’s system. Worker recommendations get a response and enter the corrective-action log.",
      },
      {
        type: "cta",
        href: "/safety/policy/joint-committee",
        label: "KYUK-POL-026 — JOINT COMMITTEE / WORKER REPRESENTATIVE →",
      },
      {
        type: "h",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            n: "02",
            title: "SAY WHY",
            body: "State the danger to the supervisor / site contact and to KYUK. Be specific: the line, the ground, the load, the missing gear, the missing plan.",
          },
          {
            n: "03",
            title: "IT GETS INVESTIGATED",
            body: "The site and KYUK deal with the condition. You are not sent home as punishment for a good-faith refusal.",
          },
          {
            n: "04",
      ...
      {
        type: "quote",
        text: "KYUK will not punish a worker for refusing unsafe work. We will not send a replacement to do the same unsafe work. That would not be a dispatch. That would be a decision to hurt someone.",
      },
      {
        type: "cta",
        href: "/safety/form/refuse-unsafe-work",
      ...
      {
        type: "p",
        text: "Workers are not units. Harassment, violence, racism, and “that’s just the trade” behaviour are not tolerated on a KYUK dispatch. Report it. We act.",
      },
      {
        type: "cta",
  ...
  },
  {
    ...
    intro:
      "These policies apply to crane operators, riggers, signalpersons, crane supervisors and safety support KYUK deploys. They are not a general construction manual.",
    library: "policy",
    blocks: [
      {
        type: "p",
        text: "Each policy is a controlled document: number, revision 01, effective 2026-09-01, owner KYUK Safety. The current version is the one on this site.",
      },
      {
        type: "p",
      ...
      },
      {
        type: "cta",
        href: "/safety/policy/bullying-and-harassment",
        label: "KYUK-POL-017 — BULLYING AND HARASSMENT →",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        label: "05 — HOW KYUK BUILDS AN SJP →",
      },
      {
        type: "cta",
        href: "/safety/swp-library",
  ...
  },
  {
    ...
    blocks: [
      {
        type: "p",
        text: "KYUK does not ask you to invent a form on the tailgate. Use these. Site forms that are stricter or required by the client are used as well — not instead of the facts these forms capture.",
      },
      {
        type: "cta",
        href: "/safety/builder",
  ...
  },
  {
    ...
    slug: "whmis-sds",
    title: "WHMIS + SDS",
    kicker: "Only what KYUK crews actually meet.",
    intro:
      "KYUK supplies people, not a warehouse. The SDS library is diesel, hydraulic oil, grease, penetrating oil, wire rope dressing, battery electrolyte and hand cleaner — products operators and riggers actually touch on a dispatch.",
    library: "sds",
    blocks: [
      {
        type: "h",
      ...
      {
        type: "p",
        text: "This is not a catalogue of construction chemicals. If KYUK does not send you to use it, it is not in this library.",
      },
    ],
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          ...
          "KYUK-controlled gear, tools and vehicles — recorded interval. Out of service when they fail.",
          "Workplace KYUK controls — monthly, with worker participation where a committee or representative exists. 3.5.",
        ],
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "MDT 219 topless. MRH 125 hydraulic luffer. MR rope luffers. Hup, Igo and Igo T self-erects. Published load charts download from Manitowoc. Serial manuals stay in the cab and on Crane Care. Complete the KYUK form for this class.",
      },
      {
        type: "cta",
        href: "/safety/crane/mdt-219",
        label: "POTAIN MDT 219 — KYUK-CRN-001 →",
      },
      {
        type: "cta",
        href: "/safety/crane/mrh-125",
        label: "POTAIN MRH 125 — KYUK-CRN-002 →",
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "Clear flat-top. Compact and Cross saddle jib. 166 B hydraulic luffer. B-series rope luffers. Published data sheets download from wolffkran.com Canada. Serial manuals stay in the cab. Calgary service and WOLFF Assist support the interval. Complete the KYUK form for this class.",
      },
      {
        type: "cta",
        href: "/safety/crane/wolff-clear",
        label: "WOLFF CLEAR — KYUK-CRN-005 →",
      },
      {
        type: "cta",
        href: "/safety/crane/wolff-166-b",
        label: "WOLFF 166 B — KYUK-CRN-007 →",
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "EC-B flat-top. HC-L rope luffers and 195 HC-LH hydraulic. K-series fast-erect. Published data sheets download from liebherr.com Canada. Serial manuals stay in the cab, on the Tower Crane Portal and on MyLiebherr. Complete the KYUK form for this class.",
      },
      {
        type: "cta",
        href: "/safety/crane/liebherr-ec-b",
        label: "LIEBHERR EC-B — KYUK-CRN-009 →",
      },
      {
        type: "cta",
        href: "/safety/crane/liebherr-hc-l",
        label: "LIEBHERR HC-L — KYUK-CRN-010 →",
      },
      {
        type: "cta",
        href: "/safety/crane/liebherr-k-series",
        label: "LIEBHERR K-SERIES — KYUK-CRN-011 →",
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "R-generation and WA flat-top. RL hydraulic luffers. L / LW / LH rope luffers. Published product pages and Manual Download PDFs from en-product.zoomlion.com. Serial manuals stay in the cab. Complete the KYUK form for this class.",
      },
      {
        type: "cta",
        href: "/safety/crane/zoomlion-flat-top",
        label: "ZOOMLION FLAT-TOP — KYUK-CRN-012 →",
      },
      {
        type: "cta",
        href: "/safety/crane/zoomlion-rl",
        label: "ZOOMLION RL — KYUK-CRN-013 →",
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "Flat-top J165 / J235. HPA hydraulic luffers. PA rope luffers. Published EN 14439 C25 and FEM 1001 sheets download from jaso.com/tower. Serial manuals stay in the cab. Smartlink and Eco Mode where fitted. Complete the KYUK form for this class.",
      },
      {
        type: "cta",
        href: "/safety/crane/jaso-flat-top",
        label: "JASO FLAT TOP — KYUK-CRN-020 →",
      },
      {
        type: "cta",
        href: "/safety/crane/jaso-hpa",
        label: "JASO HPA — KYUK-CRN-021 →",
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "SK hammerhead. SN rope luffers. SKK 140 articulated jib. Morrow published the North American range sheets. Peiner built them. Terex took Peiner in 1998. Current Terex SK sits under Raimondi. Serial manuals stay in the cab. Complete the KYUK form for this class.",
      },
      {
        type: "cta",
        href: "/safety/crane/pecco-sk",
        label: "PECCO SK — KYUK-CRN-023 →",
      },
      {
        type: "cta",
        href: "/safety/crane/pecco-sn",
        label: "PECCO SN — KYUK-CRN-024 →",
      },
      {
        type: "cta",
        href: "/safety/form/tower-pre-use",
        label: "TOWER PRE-USE — KYUK-FRM-027 →",
      },
      {
        type: "cta",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          "KYUK-POL — policies",
          "KYUK-SWP — safe work procedures",
          "KYUK-JHA — job hazard analyses",
          "KYUK-SJP — this lift, this site, this day",
          "KYUK-FRM — forms",
          "KYUK-BND — crane site binders",
          "KYUK-SDS — safety data sheets in this library",
          "KYUK-CRN — crane charts and inspection packs",
          "KYUK-RPT — field reports",
        ],
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "Revision 01. Effective 2026-09-01. Owner: KYUK Safety. Approved by: KYUK. Review by: 2027-09-01. Documents on this website are the current version. Printed copies are uncontrolled the moment they leave the screen — check the number and revision before you use a photocopy.",
      },
      {
        type: "h",
        text: "RECORDS",
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "list",
        items: [
          "Joint committee or worker representative — Act Part 2 Division 5, per workplace. KYUK-POL-026.",
          "First aid — Part 3 Division 4 and Schedule 3-A, per workplace. Host site: host’s first aid. KYUK-controlled workplace: KYUK’s assessment. KYUK-POL-025.",
          "Prime contractor — multiple-employer workplaces as the Act requires. KYUK is usually the contractor. KYUK-POL-027.",
          "Young or new worker orientation — 3.23 before they begin, every workplace. KYUK-FRM-015.",
        ],
      },
      {
        type: "cta",
        href: "/safety/form/management-review",
        label: "MANAGEMENT OHS REVIEW — KYUK-FRM-032 →",
      },
      {
        type: "cta",
        href: "/safety/policy/continuous-improvement",
        label: "KYUK-POL-016 — CONTINUOUS IMPROVEMENT →",
      },
      {
        type: "cta",
        href: "/safety/policy/contractors",
        label: "KYUK-POL-027 — CONTRACTORS AND MULTI-EMPLOYER SITES →",
      },
    ],
  },
  {
    ...
    intro:
      "A tower or self-erect on a B.C. construction site needs a site binder. BC Crane Safety wrote the checklists. WorkSafeBC requires the Notice of Project — Tower Crane. The wizard builds the KYUK copy: numbered items, who holds them, and the downloadable forms.",
    library: "binder",
    blocks: [
      {
        type: "quote",
      ...
      },
      {
        ...
        items: [
          ...
          "Opens the KYUK form and the official download (30M33, 52E73C, NOP-TC, tower crane report, NAV CANADA).",
          "Downloads a KYUK checklist PDF for this site. Saved on this device.",
        ],
      },
      {
        type: "h",
      ...
      },
      {
        ...
        label: "NOP-TC POSTING NOTICE — KYUK-FRM-039 →",
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "Official paper stays official. KYUK sheets are the working copy and the cover. Form 30M33 is coded by WorkSafeBC — order it; the KYUK record is the schematic and the discussion. Radio coordination is 52E73C. The tower crane report is WorkSafeBC’s checklist after erect, climb or reposition.",
      },
      {
        type: "cta",
        href: "/safety/form/powerline-30m33",
        label: "30M33 / POWERLINE RECORD — KYUK-FRM-037 →",
      },
      {
        type: "cta",
        href: "/safety/form/radio-frequency",
        label: "RADIO FREQUENCY — KYUK-FRM-038 →",
      },
      {
        type: "cta",
        href: "/safety/form/tower-crane-report",
        label: "TOWER CRANE REPORT — KYUK-FRM-041 →",
      },
      {
        type: "h",
      ...
      {
        type: "p",
        text: "Table of contents, notes, and OHSR / CSA info files live on BC Crane Safety. Use them. This program does not host their PDFs as if they were KYUK documents.",
      },
      {
        type: "cta",
