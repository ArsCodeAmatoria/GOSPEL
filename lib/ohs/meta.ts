...
export const CREW_ROLES: RoleLine[] = [
  ...
  {
    title: "Supervisor",
    body: "Confirms the plan, the crew, the zone and the stop criteria. Owns whether the hook moves when 1415 is supplying supervision.",
  },
  {
...
export const LIGHTNING_RULE: DocTable = {
  caption: "LIGHTNING — 1415 STOP. THUNDER IS THE TRIGGER. DO NOT COUNT TO 30.",
...
export const LIGHTNING_BANG: DocTable = {
  ...
  columns: ["SECONDS AFTER FLASH", "~DISTANCE", "1415"],
  rows: [
...
export const LIGHTNING_REFS = [
  ...
  "ECCC dropped the first 30 of the 30/30 rule in 2010. People waited until a 30-second flash-to-bang. That is too late. 1415 does not count to 30 before stopping.",
...
export const FLYTABLE_REFS = [
  ...
  "OHS Regulation Part 20 — formwork and falsework. Host / prime duty. 1415 does not write the cycling carpentry.",
...
export const FLYTABLE_ROLES: RoleLine[] = [
  ...CREW_ROLES,
  {
    ...
    body: "Drops, rolls and lands the table to the manufacturer cycle and the engineered drawing. 1415 does not lower jacks or invent a cycling sequence.",
  },
  {
...
export const PLATFORM_HITCH: DocTable = {
  ...
  rows: [
    ...
    ["Daily SuperDeck / Super Roller / DOC extend and retract is host. 1415 is not hooked.", "Preston FAQ. CantiDeck. DOC."],
  ],
};
...
export const PLATFORM_ROLES: RoleLine[] = [
  ...CREW_ROLES,
  {
    ...
    body: "Rails, props, clamps or through-slab anchors to the OEM and the engineered drawing. 1415 does not invent a propping sequence. Says when the deck is landed and in service.",
  },
  {
    title: "Prime contractor",
