...
export const POLICIES: Policy[] = [
  {
    ...
    number: "1415-POL-001",
    summary:
      "This is 1415’s occupational health and safety policy. The work is done to this program, to the law, and to the machine.",
    statements: [
      {
        title: "Aims",
        body: "Prevent injury and occupational disease on crane and rigging work 1415 accepts. Put competent people on the machine. Back stop-work. Keep this program public so workers and clients can read it before the dispatch. OHS Regulation 3.3(a).",
      },
      {
        title: "Commitment",
        body: "1415 provides the people, instruction, supervision and backing this program names. Production does not outrank the chart, the hitch, or the three rights.",
      },
      {
        title: "Objectives",
      ...
      {
        title: "Scope",
        body: "Applies to every crane operator, rigger, signalperson and lifting supervisor 1415 deploys, and to every lift we accept.",
      },
      {
        title: "Standard",
  ...
  },
  {
    ...
    number: "1415-POL-002",
    summary:
      "A ticket is not competency. 1415 matches people to the machine, the lift and the site.",
    statements: [
      {
  ...
  },
  {
    ...
    statements: [
      ...
      },
      {
        ...
        body: "A young worker is under 25. A new worker is new to that workplace, returning to changed hazards, or relocated to different hazards. 3.22. Before they begin, they get the orientation topics in 3.23 — supervisor name, rights including refusal, rules, hazards, working alone, violence, PPE, first aid, emergency, the task, this program, WHMIS as it applies, committee or worker-rep contact. Extra orientation if they cannot do the work safely or they ask. 3.24. Record it. 3.25. 1415-FRM-015.",
      },
      {
        title: "Site orientation",
        body: "The host’s site orientation is the host’s. 1415 arranges it. The worker does not start the lift without it when the site requires it.",
      },
      {
        title: "Supervisor instruction",
        body: "People 1415 sends to supervise a lift are instructed in this program, in stop-work, and in the supervisor duties under the Workers Compensation Act s. 23. A ticket is not that instruction.",
      },
      {
        title: "Refresher",
  ...
  },
  {
    ...
    number: "1415-POL-005",
    summary:
      "Every 1415 dispatch requires a hazard assessment. FLHA at the shift. Reassess when the work changes.",
    statements: [
      {
  ...
  },
  {
    ...
    statements: [
      ...
      {
        title: "Learn",
        body: "1415 investigates events involving our people. Controls change. This program is updated when the lesson is real. Injuries also follow Injury Management and Return to Work.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    number: "1415-POL-008",
    summary:
      "The three rights are operating procedure. 1415 will not send a replacement to do the same unsafe work.",
    statements: [
      {
        title: "Stop",
      ...
      {
        title: "Say why",
        body: "State the danger to site supervision and to 1415. Be specific: the line, the ground, the load, the missing plan.",
      },
      {
        title: "It stays stopped",
        body: "Work resumes when the danger is controlled. 1415 will not punish a good-faith refusal. 1415 will not dispatch a replacement into the same uncontrolled condition.",
      },
    ],
  },
  {
    ...
    number: "1415-POL-009",
    summary:
      "Threats and physical violence are not part of a lift. Harassment is 1415-POL-017. Report them. We act. OHS Regulation Part 4.",
    statements: [
      {
        title: "Zero for violence",
        body: "Physical violence, threats and intimidation toward a 1415 worker — or by a 1415 worker — are reported and acted on. Immediate danger: get out and call for help.",
      },
      {
      ...
      },
      {
        ...
        body: "Humiliation, racism, sexual harassment and “that’s just the trade” are covered by 1415-POL-017 Bullying and Harassment — Workers Compensation Act s. 21, WorkSafeBC P2-21-2.",
      },
    ],
  },
  {
    ...
    statements: [
      ...
      },
      {
        ...
        body: "1415 issues or confirms required PPE for the dispatch. Failed PPE is replaced or the worker does not start. Record issue and replacement on 1415-FRM-018. Workers do not start the lift waiting on a hat.",
      },
      {
        title: "Instruction",
  ...
  },
  {
    ...
    statements: [
      ...
      {
        title: "No guess",
        body: "Weight and centre of gravity are confirmed. Sling angle is calculated when it matters. Below 30° from horizontal is not a 1415 hitch unless an engineer owns the numbers.",
      },
      {
  ...
  },
  {
    ...
    statements: [
      {
        title: "Crane",
        body: "Operator inspection each shift as the manufacturer, the named 14.2 standard, and Part 14 require. Defects that affect lifting keep the crane down. Tower, hammerhead, luffing jib and self-erecting machines: see Inspections — OEM charts and 1415-FRM-027 through 031.",
      },
      {
        title: "Rigging",
      ...
      },
      {
        ...
        body: "Preventive maintenance of a crane belongs to the owner of that crane — OEM interval, logbook, annual certification. 1415 is a workforce. If 1415 does not own the machine, the operator still completes pre-use and reports defects. The crane does not lift with a known defect that affects lifting.",
      },
      {
        title: "1415-controlled gear",
        body: "Rigging, PPE, tools and vehicles 1415 controls are inspected, maintained and taken out of service when they fail. Weekly and monthly maintenance forms apply to machines 1415 is assigned to maintain. Return to service only after the repair is verified.",
      },
      {
  ...
  },
  {
    ...
    statements: [
      ...
      },
      {
        ...
        body: "Smoke is an exposure, not weather small-talk. If air quality makes the work unsafe — cab or open — stop. The site and 1415 are told. Resume only when the plan says so.",
      },
    ],
  },
  {
    ...
    statements: [
      {
        title: "Before work",
        body: "Emergency number, muster, first aid, crane shutdown, fall-rescue if anyone is tied off, high-angle rope rescue for a tower operator, 1415 after-hours contact.",
      },
      {
        title: "People first",
      ...
      },
      {
        ...
        body: "A hoist car is working alone. If 1415 supplies that operator, the site uses a written rescue procedure before the car runs. BCCSA already wrote the templates. Use them. Do not invent a hoist rescue on the day.",
      },
      {
        title: "Fall arrest",
      ...
      },
      {
        ...
        body: "WorkSafeBC G4.13(3)(a): risk assessment where rescue or evacuation may arise, and written procedures for high-angle work. BCCSA’s Technical High Angle Rope Rescue Program connects construction employers with funded municipal fire departments to write a rope-rescue plan for a tower-crane operator in distress. 1415 does not run that rescue. The fire department does. A 1415 tower operator is not sent up until the host or prime can name the plan, the fire department, and how to summon them. If the local department is not THARR-funded, mutual aid or another acceptable means is required — the lift does not invent it. Portal requests: bccsa.ca/tharrp_program.php.",
      },
      {
        title: "Who requests the survey",
        body: "The employer at that workplace requests the crane or site survey in the THARRP Portal — WorkSafeBC account number and legal name. On a host site that is usually the prime or the crane owner. 1415 is construction labour supply; ADM 2 lists that classification among the funding units. 1415 confirms the survey and the written agreement exist before the dispatch. A tower on a high-rise expected past 60 days needs the formal Site Survey & Site Rescue Procedure Review on site. ADM 2.",
      },
    ],
  },
  {
    ...
    statements: [
      ...
      },
      {
        ...
        body: "1415 holds a periodic management OHS meeting to review safety activities and incident trends and to decide what changes. 3.3(d). At least quarterly, and after a serious incident. Agenda: incidents, inspections, outstanding corrective actions, training, worker concerns and refusals, COR / audit results, objectives. 1415-FRM-032.",
      },
      {
      ...
      {
        title: "COR",
        body: "1415 is COR® certified through BCCSA. Certification is of this occupational health and safety management system. Maintenance and recertification follow BCCSA’s current process. An audit finding becomes a corrective action with an owner and a date.",
      },
      {
        title: "This program",
  ...
  },
  {
    ...
    number: "1415-POL-017",
    summary:
      "Not acceptable. Not “the trade.” Report it. 1415 deals with it. WorkSafeBC P2-21-2, P2-22-1, P2-23-2.",
    statements: [
      {
        title: "Policy statement",
        body: "Workplace bullying and harassment is not acceptable or tolerated at 1415, on a 1415 dispatch, or toward a 1415 worker. This is the policy statement required of an employer under WorkSafeBC P2-21-2(a). 1415 does not engage in bullying and harassment of workers or supervisors.",
      },
      {
        title: "What it is",
        body: "Any inappropriate conduct or comment toward a worker that the person knew, or reasonably ought to have known, would humiliate or intimidate that worker. It includes sexual harassment, racism, isolation, sabotage of someone’s work, and “that’s just the trade.” The person can be anyone on the job — 1415, a client, another contractor’s crew.",
      },
      {
      ...
      {
        title: "Scope",
        body: "Applies to every crane operator, rigger, signalperson and lifting supervisor 1415 deploys, and to 1415 supervisors. It applies on client sites. A multiple-employer workplace does not cancel 1415’s duty to its workers.",
      },
      {
        title: "1415",
      ...
      {
        title: "How to report",
        body: "Report as soon as you can. Call 1415 at 1 604 431 2000 and ask for Safety, email hire@kyuk.onl with the subject BULLYING AND HARASSMENT, or use Report Bullying or Harassment under Incident Reporting. Say who, when, where, what was said or done, and who saw it. You do not need a form if a call is faster.",
      },
      {
        title: "If the alleged person is 1415",
        body: "If the alleged bully is your 1415 supervisor or a person acting for 1415, do not report only to that person. Call 1415 and ask for Safety, or email hire@kyuk.onl. If the alleged person is the employer itself and you cannot use the internal route, call the WorkSafeBC Prevention Information Line: 1 888 621 7233.",
      },
      {
        title: "How 1415 deals with it",
        body: "1415 Safety, or a person who is not the alleged bully, investigates promptly and fairly. The investigation covers what happened, who was involved, when and where, witnesses, and any record. The people involved are heard. Confidentiality is kept as far as the investigation allows. Follow-up includes corrective action and a timeline. Records are kept by 1415. They are not sent to WorkSafeBC unless asked for.",
      },
      {
        title: "No punishment for good faith",
  ...
  },
  {
    ...
    number: "1415-POL-018",
    summary:
      "You represent 1415 on someone else’s site. Show up. Be competent. Do not make the lift about you.",
    statements: [
      {
        title: "On the dispatch",
        body: "1415 workers arrive on time, briefed, and fit for the work. If you cannot make the call, 1415 hears it first — not the gate.",
      },
      {
      ...
      },
      {
        ...
        body: "1415 remains your employer. Site direction that is unsafe is refused under the three rights. Site direction that is lawful and stricter than ours is followed.",
      },
    ],
  },
  {
    ...
    statements: [
      ...
      {
        title: "1415 does not assign it",
        body: "1415 does not put a person who is not fit onto a crane, a hitch, or a set of signals. A replacement is found, or the dispatch waits. Covering with hope is not a dispatch.",
      },
      {
        title: "Medical information",
        body: "1415 asks only what is needed to match the person to the work and to accommodate where the law requires it. It is not a fishing trip. See Impairment and Return to Work.",
      },
    ],
  },
  {
    ...
    statements: [
      {
        title: "The rule",
        body: "A person must not enter or remain at a workplace while their ability to work is affected by alcohol, a drug or another substance so as to endanger anyone. 1415 must not knowingly permit it. 4.20. Crane operation, rigging and signalling are safety-sensitive. There is no ‘a little bit’ on a hook.",
      },
      {
        title: "What counts",
      ...
      {
        title: "Report it",
        body: "Workers report impairment to 1415 before they attend, start, or continue. Observed impairment is treated the same as reported impairment. The person comes off the lift. They are not left in the cab to ‘sleep it off.’",
      },
      {
        title: "Testing",
        body: "1415 does not run random drug or alcohol testing as a default. Testing happens only where the law allows and the situation requires it. Client or prime-contractor programs that are lawful are followed for that site. A test is not a substitute for taking an impaired person off the work.",
      },
      {
        title: "Disability",
        body: "Addiction and other disabilities are protected under the Human Rights Code. 1415 will accommodate to the point of undue hardship when it is told. Accommodation is not a licence to lift impaired. See Discrimination and Fitness for Work.",
      },
    ],
  },
  {
    ...
    statements: [
      {
        title: "No solo lift",
        body: "1415 does not dispatch a worker to make a lift alone. Operator, rigger and signals are a crew. If the site will leave one 1415 person to lift, we do not take that dispatch.",
      },
      {
        title: "When this policy applies",
        body: "Working alone or in isolation means assistance would not be readily available in an emergency, injury or illness. Visual or verbal contact with other people is readily available. A phone or radio is not. Travel, waiting on a machine, a remote plant, night work, or a crew that left can put a 1415 worker in isolation even when the lift itself was crewed.",
      },
      {
        title: "Before that dispatch",
        body: "Hazards are identified. A written procedure is set: who checks in, how, and how often — matching the risk. The worker is trained on it. If the site cannot support that, 1415 does not send the person.",
      },
      {
        title: "Check-in",
        body: "A named person at 1415 or on site receives the check-in at the set times. Missed check-in is not a voicemail. The designated person calls, then escalates, then sends help or emergency services. A spouse is not the check-in system.",
      },
      {
        title: "Say it",
        body: "If you will be out of visual and verbal contact, you tell 1415 before the hook. We set the check-in or we pull the dispatch.",
      },
    ],
  },
  {
    ...
    download: {
      ...
      note: "BCCSA employer guide, employee bulletin, sample forms and supplementary materials. Use them. Do not replace 1415-POL-022.",
    },
    statements: [
      {
        title: "Care",
        body: "Injured people get first aid and further care as required. Make the lift safe. Do not become the second event. Site first aid and 1415 are both told.",
      },
      {
        title: "Report",
        body: "Injuries are reported the same shift — including what someone calls nothing. First aid report 1415-FRM-012. Incident report as required. WorkSafeBC is notified as the law requires. Hiding an injury to finish a pick is how it becomes a worse injury.",
      },
      {
        title: "Stay at work",
  ...
  },
  {
    ...
    statements: [
      {
        title: "Suitable work",
        body: "Return-to-work is work the person can do within named restrictions. 1415 does not dispatch an operator, rigger or signalperson into a role that violates those restrictions. The form is 1415-FRM-RTW.",
      },
      {
        title: "Plan",
      ...
      {
        title: "Duty",
        body: "Where the Workers Compensation Act duty to maintain employment applies, 1415 maintains employment and offers suitable or pre-injury work to the point of undue hardship. Inconvenience is not undue hardship.",
      },
      {
        title: "Cooperate",
        body: "The worker, 1415, the clinician and WorkSafeBC share what is needed to match the work. Medical detail beyond the restriction is not a gossip file. See Fitness for Work and Injury Management.",
      },
    ],
  },
  {
    ...
    statements: [
      {
        title: "The Code",
        body: "1415 does not refuse to employ, refuse to continue to employ, or discriminate in any term of employment — including who gets the call — because of Indigenous identity, race, colour, ancestry, place of origin, political belief, religion, marital status, family status, physical or mental disability, sex, sexual orientation, gender identity or expression, age, or a conviction unrelated to the work. Human Rights Code s. 13. 1415 does not refuse to refer a person for those reasons.",
      },
      {
        title: "This work",
      ...
      {
        title: "Accommodate",
        body: "1415 accommodates protected characteristics to the point of undue hardship. Accommodation does not put an impaired or restricted person onto a hook that the restriction forbids. See Fitness for Work, Impairment and Return to Work.",
      },
      {
        title: "Report",
        body: "Report to 1415 at 1 604 431 2000 and ask for Safety, or email hire@kyuk.onl. If the alleged person is 1415, use that route anyway and name it. A complaint may also be filed with the BC Human Rights Tribunal. Bullying and harassment under WorkSafeBC is a separate file — 1415-POL-017 — and both can apply.",
      },
    ],
  },
  {
    ...
    number: "1415-POL-025",
    summary:
      "First aid follows the workplace. On a client site that is usually the host. On a workplace 1415 controls, 1415 does the assessment.",
    statements: [
      {
      ...
      },
      {
        ...
        body: "On a construction or industrial site 1415 does not control, first aid is the host’s or the prime contractor’s. Before work, the crew knows where it is, who the attendant is, and how to summon it. That goes on the FLHA. 1415-FRM-012 is still completed for a 1415 worker.",
      },
      {
        title: "Workplace 1415 controls",
        body: "If 1415 is the employer at a workplace it controls — office, yard, shop — 1415 conducts the first-aid assessment, posts it, and provides the equipment, attendants and procedures that assessment requires. Review when the workforce or the work changes.",
      },
      {
        title: "Records",
  ...
  },
  {
    ...
    number: "1415-POL-026",
    summary:
      "Committee or worker representative follows the Act for that workplace. It is not a poster 1415 invents for every site.",
    statements: [
      {
        title: "The threshold",
        body: "Workers Compensation Act Part 2 Division 5. A joint health and safety committee is required at a workplace where 20 or more workers are regularly employed. A worker health and safety representative is required where 9 to 19 workers are regularly employed. Other orders can apply. This is per workplace — not a headcount of everyone 1415 has ever dispatched.",
      },
      {
        title: "Workplace 1415 controls",
        body: "At a workplace 1415 regularly employs people and controls, 1415 establishes the committee or representative the Act requires. New members get the training in OHS Regulation 3.27. A joint committee is evaluated annually where 3.26 applies.",
      },
      {
        title: "Client / host site",
        body: "1415 workers on a host site participate in that workplace’s committee or representative system as the host and the Act require. 1415 remains the employer of its people. A multiple-employer workplace does not erase that.",
      },
      {
        title: "Below the threshold",
        body: "If a 1415-controlled workplace is below the committee and representative thresholds, 3.2 still requires regular monthly meetings with workers on health and safety, and a record of what was discussed. 1415-FRM-033.",
      },
      {
  ...
  },
  {
    ...
    number: "1415-POL-027",
    summary:
      "1415 is usually the contractor. The host owns the site. The prime contractor owns coordination where the Act requires one. Subcontractors 1415 hires are selected and watched.",
    statements: [
      {
        title: "1415",
      ...
      {
        title: "1415 workers",
        body: "Work to this program and to site rules — whichever is stricter. Report to 1415 and to site supervision. Refuse unsafe work.",
      },
      {
      ...
      },
      {
        ...
        body: "When 1415 supplies lift supervision, that person owns whether the hook moves. They do not own the entire site.",
      },
      {
        title: "Prime contractor",
        body: "On a multiple-employer workplace the Act requires a prime contractor to coordinate. 1415 asks who that is before people are sent. If nobody can name them, that is a hazard. It is named. The lift waits until coordination is real.",
      },
      {
        title: "Subcontractors 1415 hires",
        body: "If 1415 hires another company — a rigger shop, a signal crew, a carrier — selection includes their ability to identify, communicate and control hazards that affect their people, ours, and anyone else. They get this program and the host’s rules. 1415 monitors the work we hired them for. A COR card is evidence, not a substitute for watching the hitch.",
      },
      {
        title: "Orientation and communication",
        body: "Host orientation is completed as the site requires. 1415 shares what the host needs: FLHA, inspections, incidents involving our people. The host shares what we need: known hazards, other cranes, lines, first aid, muster.",
      },
    ],
  },
  {
    ...
    statements: [
      ...
      },
      {
        ...
        body: "WHMIS for products 1415 people use — diesel, hydraulic oil, grease, rope dressing. SDS library 18. The host’s products stay on the host’s SDS.",
      },
      {
