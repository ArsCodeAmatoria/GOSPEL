...
export const WSBC_33: SystemRow[] = [
  ...
  },
  {
    ...
    owner: "KYUK Safety with the crew",
  ...
  },
  {
    ...
    owner: "KYUK before dispatch. Supervisor on the lift.",
...
export const COR_ELEMENTS: SystemRow[] = [
  ...
  },
  {
    ...
    owner: "Owner of the machine for PM. KYUK operator for pre-use and defect reports.",
    frequency: "OEM interval for KYUK-controlled gear. Client/owner PM for their crane.",
    note: "KYUK is a workforce. Most cranes are not ours. Pre-use and defect reporting still are.",
  },
  {
    id: "COR 8",
  ...
  },
  {
    ...
    form: "FRM-034 drill",
    record: "Site brief on the FLHA. Drill record where KYUK controls the workplace.",
    owner: "Supervisor on the dispatch. Host employer for the site ERP.",
    frequency: "Briefed before work. Drills where KYUK is the employer at that workplace. Tower: THARRP plan confirmed before the operator goes up.",
  },
  {
    id: "COR 12",
  ...
  },
  {
    ...
    record: "Who is prime. What the host required. What KYUK verified before sending people.",
    owner: "KYUK",
    frequency: "Each dispatch.",
    note: "KYUK is usually the contractor on a host site — not the prime. Subcontractors KYUK hires are selected and monitored to this policy.",
  },
];

export const PROGRAM_HIERARCHY = [
  { title: "PROVEN", body: "KYUK’s safety system. How it runs. Section 21 is the map." },
  { title: "POLICIES", body: "KYUK-POL. The rules. Library 13." },
  ...
  { title: "FORMS", body: "KYUK-FRM. How evidence is collected. Library 16 and the form builder." },
