...
export const WSBC_33: SystemRow[] = [
  ...
  },
  {
    ...
    owner: "1415 Safety with the crew",
  ...
  },
  {
    ...
    owner: "1415 before dispatch. Supervisor on the lift.",
...
export const COR_ELEMENTS: SystemRow[] = [
  ...
  },
  {
    ...
    owner: "Owner of the machine for PM. 1415 operator for pre-use and defect reports.",
    frequency: "OEM interval for 1415-controlled gear. Client/owner PM for their crane.",
    note: "1415 is a workforce. Most cranes are not ours. Pre-use and defect reporting still are.",
  },
  {
    id: "COR 8",
  ...
  },
  {
    ...
    form: "FRM-034 drill",
    record: "Site brief on the FLHA. Drill record where 1415 controls the workplace.",
    owner: "Supervisor on the dispatch. Host employer for the site ERP.",
    frequency: "Briefed before work. Drills where 1415 is the employer at that workplace. Tower: THARRP plan confirmed before the operator goes up.",
  },
  {
    id: "COR 12",
  ...
  },
  {
    ...
    record: "Who is prime. What the host required. What 1415 verified before sending people.",
    owner: "1415",
    frequency: "Each dispatch.",
    note: "1415 is usually the contractor on a host site — not the prime. Subcontractors 1415 hires are selected and monitored to this policy.",
  },
];

export const PROGRAM_HIERARCHY = [
  { title: "PROVEN", body: "1415’s safety system. How it runs. Section 21 is the map." },
  { title: "POLICIES", body: "1415-POL. The rules. Library 13." },
  ...
  { title: "FORMS", body: "1415-FRM. How evidence is collected. Library 16 and the form builder." },
