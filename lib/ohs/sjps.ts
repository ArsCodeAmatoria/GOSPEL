...
export const SJPS: Sjp[] = [
  {
    ...
    when: "Every flytable / flyform cycle KYUK hooks. Critical lift. Fill KYUK-FRM-052. Typical tables only — corner and nontypical use KYUK-SJP-002 on the same form.",
    purpose:
      "Name the facts the SWP cannot know until this morning: table ID, drawing revision, weight, pick points, sling lengths, wind number, named crew, holds. The method stays KYUK-SWP-028. If this sheet contradicts the SWP, stop and fix one of them before the hook moves.",
    basedOn: [
      { href: "/safety/swp/flytable-cycling", label: "SWP — FLYTABLE CYCLING — KYUK-SWP-028 →" },
      { href: "/safety/jha/flytable-cycling", label: "JHA — FLYTABLE CYCLING — KYUK-JHA-011 →" },
      { href: "/safety/swp/critical-lifts", label: "SWP — CRITICAL LIFTS — KYUK-SWP-019 →" },
      { href: "/safety/form/flytable-cycle-sjp", label: "FILL THIS CYCLE — KYUK-FRM-052 →" },
    ],
    facts: [
    ...
    abort: [
      ...
      "The work is being asked to drift from KYUK-SWP-028",
    ...
    named: [
      ...
      "Prime contact",
      "KYUK supervisor if dispatched",
    ],
    documentation: [
      "This SJP / KYUK-FRM-052",
      "KYUK-FRM-007",
      "KYUK-FRM-009",
      "FLHA",
    ...
    download: {
      ...
      label: "FILL KYUK-FRM-052 — THIS CYCLE →",
    },
  ...
  },
  {
    ...
    when: "The table is a corner, infill, reduced-width, or any table the engineer marks nontypical. Fill KYUK-FRM-052 and mark it nontypical. Attach the special handling plan.",
    purpose:
      "Force the special facts onto paper: why this table is not typical, the engineered handling plan, the different sling geometry, the extra tag line. Then do KYUK-SWP-028 on top of that plan. Do not fly this table on KYUK-SJP-001 alone.",
    basedOn: [
      { href: "/safety/swp/corner-nontypical-flytables", label: "SWP — CORNER AND NONTIPICAL FLYTABLES — KYUK-SWP-029 →" },
      { href: "/safety/jha/corner-nontypical-flytables", label: "JHA — CORNER AND NONTIPICAL FLYTABLES — KYUK-JHA-012 →" },
      { href: "/safety/sjp/flytable-cycle", label: "SJP — TYPICAL CYCLE — KYUK-SJP-001 →" },
      { href: "/safety/form/flytable-cycle-sjp", label: "FILL THIS CYCLE — KYUK-FRM-052 →" },
    ],
    facts: [
      "Everything KYUK-SJP-001 names",
    ...
    abort: [
      ...
      "Every abort on KYUK-SJP-001",
    ],
    named: [
      "Everyone named on KYUK-SJP-001",
      "Extra tag-line hands the special plan names",
      "Engineer contact if the table or the plan changed",
    ],
    documentation: [
      "KYUK-FRM-052 marked nontypical",
      "Special handling plan attached",
      "KYUK-SJP-001 documentation",
    ],
    references: [...LIFT_REFS, ...FLYTABLE_REFS],
    download: {
      href: "/safety/builder/flytable-cycle-sjp",
      label: "FILL KYUK-FRM-052 — MARK NONTIPICAL →",
    },
    links: FLYTABLE_LINKS,
  },
  {
    ...
    when: "Every loading-platform install, reposition or strike KYUK hooks. Critical lift. Fill KYUK-FRM-053. Daily SuperDeck extend / retract is not this sheet.",
    purpose:
      "Name the facts the SWP cannot know until this morning: manufacturer, serial, dead weight, WLL, pick points, chain, wind number, named crew, holds. The method stays KYUK-SWP-030. If this sheet contradicts the SWP, stop and fix one of them before the hook moves.",
    basedOn: [
      { href: "/safety/swp/loading-platform-reposition", label: "SWP — LOADING PLATFORM — KYUK-SWP-030 →" },
      { href: "/safety/jha/loading-platform-reposition", label: "JHA — LOADING PLATFORM — KYUK-JHA-014 →" },
      { href: "/safety/swp/critical-lifts", label: "SWP — CRITICAL LIFTS — KYUK-SWP-019 →" },
      { href: "/safety/form/loading-platform-sjp", label: "FILL THIS DECK — KYUK-FRM-053 →" },
    ],
    facts: [
      "Project, building, floor leaving, floor landing",
    ...
    abort: [
      ...
      "The work is being asked to drift from KYUK-SWP-030",
    ],
    named: [
      "Operator",
      "Rigger",
    ...
    download: {
      ...
      label: "FILL KYUK-FRM-053 — THIS DECK →",
    },
