...
export const SJPS: Sjp[] = [
  {
    ...
    number: "WHOOP-SJP-001",
    summary: "This table. This floor. This drawing revision. Not last cycle’s sheet.",
    when: "Every flytable / flyform cycle WHOOP hooks. Critical lift. Fill WHOOP-FRM-052. Typical tables only — corner and nontypical use WHOOP-SJP-002 on the same form.",
    purpose:
      "Name the facts the SWP cannot know until this morning: table ID, drawing revision, weight, pick points, sling lengths, wind number, named crew, holds. The method stays WHOOP-SWP-028. If this sheet contradicts the SWP, stop and fix one of them before the hook moves.",
    basedOn: [
      { href: "/safety/swp/flytable-cycling", label: "SWP — FLYTABLE CYCLING — WHOOP-SWP-028 →" },
      ...
      { href: "/safety/form/flytable-cycle-sjp", label: "FILL THIS CYCLE — WHOOP-FRM-052 →" },
    ],
    facts: [
    ...
    abort: [
      ...
      "The work is being asked to drift from WHOOP-SWP-028",
    ...
    download: {
      ...
      label: "FILL WHOOP-FRM-052 — THIS CYCLE →",
    },
  ...
  },
  {
    ...
    number: "WHOOP-SJP-002",
    summary: "This corner table. This special plan. Not the typical cycle sheet.",
    when: "The table is a corner, infill, reduced-width, or any table the engineer marks nontypical. Fill WHOOP-FRM-052 and mark it nontypical. Attach the special handling plan.",
    purpose:
      "Force the special facts onto paper: why this table is not typical, the engineered handling plan, the different sling geometry, the extra tag line. Then do WHOOP-SWP-028 on top of that plan. Do not fly this table on WHOOP-SJP-001 alone.",
    basedOn: [
      { href: "/safety/swp/corner-nontypical-flytables", label: "SWP — CORNER AND NONTIPICAL FLYTABLES — WHOOP-SWP-029 →" },
      { href: "/safety/jha/corner-nontypical-flytables", label: "JHA — CORNER AND NONTIPICAL FLYTABLES — WHOOP-JHA-012 →" },
      { href: "/safety/sjp/flytable-cycle", label: "SJP — TYPICAL CYCLE — WHOOP-SJP-001 →" },
      { href: "/safety/form/flytable-cycle-sjp", label: "FILL THIS CYCLE — WHOOP-FRM-052 →" },
    ],
    facts: [
      "Everything WHOOP-SJP-001 names",
    ...
    holds: [
      ...
      {
        n: "02",
        title: "THEN WHOOP-SJP-001 HOLDS",
