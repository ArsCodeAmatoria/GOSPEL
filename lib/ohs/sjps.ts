...
export const SJPS: Sjp[] = [
  {
    ...
    when: "Every flytable / flyform cycle 1415 hooks. Critical lift. Fill 1415-FRM-052. Typical tables only — corner and nontypical use 1415-SJP-002 on the same form.",
    purpose:
      "Name the facts the SWP cannot know until this morning: table ID, drawing revision, weight, pick points, sling lengths, wind number, named crew, holds. The method stays 1415-SWP-028. If this sheet contradicts the SWP, stop and fix one of them before the hook moves.",
    basedOn: [
      { href: "/safety/swp/flytable-cycling", label: "SWP — FLYTABLE CYCLING — 1415-SWP-028 →" },
      { href: "/safety/jha/flytable-cycling", label: "JHA — FLYTABLE CYCLING — 1415-JHA-011 →" },
      { href: "/safety/swp/critical-lifts", label: "SWP — CRITICAL LIFTS — 1415-SWP-019 →" },
      { href: "/safety/form/flytable-cycle-sjp", label: "FILL THIS CYCLE — 1415-FRM-052 →" },
    ],
    facts: [
    ...
    abort: [
      ...
      "The work is being asked to drift from 1415-SWP-028",
    ...
    named: [
      ...
      "Prime contact",
      "1415 supervisor if dispatched",
    ],
    documentation: [
      "This SJP / 1415-FRM-052",
      "1415-FRM-007",
      "1415-FRM-009",
      "FLHA",
    ...
    download: {
      ...
      label: "FILL 1415-FRM-052 — THIS CYCLE →",
    },
  ...
  },
  {
    ...
    when: "The table is a corner, infill, reduced-width, or any table the engineer marks nontypical. Fill 1415-FRM-052 and mark it nontypical. Attach the special handling plan.",
    purpose:
      "Force the special facts onto paper: why this table is not typical, the engineered handling plan, the different sling geometry, the extra tag line. Then do 1415-SWP-028 on top of that plan. Do not fly this table on 1415-SJP-001 alone.",
    basedOn: [
      { href: "/safety/swp/corner-nontypical-flytables", label: "SWP — CORNER AND NONTIPICAL FLYTABLES — 1415-SWP-029 →" },
      { href: "/safety/jha/corner-nontypical-flytables", label: "JHA — CORNER AND NONTIPICAL FLYTABLES — 1415-JHA-012 →" },
      { href: "/safety/sjp/flytable-cycle", label: "SJP — TYPICAL CYCLE — 1415-SJP-001 →" },
      { href: "/safety/form/flytable-cycle-sjp", label: "FILL THIS CYCLE — 1415-FRM-052 →" },
    ],
    facts: [
      "Everything 1415-SJP-001 names",
    ...
    abort: [
      ...
      "Every abort on 1415-SJP-001",
    ],
    named: [
      "Everyone named on 1415-SJP-001",
      "Extra tag-line hands the special plan names",
      "Engineer contact if the table or the plan changed",
    ],
    documentation: [
      "1415-FRM-052 marked nontypical",
      "Special handling plan attached",
      "1415-SJP-001 documentation",
    ],
    references: [...LIFT_REFS, ...FLYTABLE_REFS],
    download: {
      href: "/safety/builder/flytable-cycle-sjp",
      label: "FILL 1415-FRM-052 — MARK NONTIPICAL →",
    },
    links: FLYTABLE_LINKS,
  },
  {
    ...
    when: "Every loading-platform install, reposition or strike 1415 hooks. Critical lift. Fill 1415-FRM-053. Daily SuperDeck extend / retract is not this sheet.",
    purpose:
      "Name the facts the SWP cannot know until this morning: manufacturer, serial, dead weight, WLL, pick points, chain, wind number, named crew, holds. The method stays 1415-SWP-030. If this sheet contradicts the SWP, stop and fix one of them before the hook moves.",
    basedOn: [
      { href: "/safety/swp/loading-platform-reposition", label: "SWP — LOADING PLATFORM — 1415-SWP-030 →" },
      { href: "/safety/jha/loading-platform-reposition", label: "JHA — LOADING PLATFORM — 1415-JHA-014 →" },
      { href: "/safety/swp/critical-lifts", label: "SWP — CRITICAL LIFTS — 1415-SWP-019 →" },
      { href: "/safety/form/loading-platform-sjp", label: "FILL THIS DECK — 1415-FRM-053 →" },
    ],
    facts: [
      "Project, building, floor leaving, floor landing",
    ...
    abort: [
      ...
      "The work is being asked to drift from 1415-SWP-030",
    ],
    named: [
      "Operator",
      "Rigger",
    ...
    download: {
      ...
      label: "FILL 1415-FRM-053 — THIS DECK →",
    },
