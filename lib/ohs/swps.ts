...
function swp(
  ...
  return {
    ...
    emergency:
      fields.emergency ??
      "Stop the lift. Make people safe. Land or hold the load if it can be done without a second incident. First aid. Notify the site and 1415. Hold the scene.",
...
export const SWPS: Swp[] = [
  swp("1415-SWP-001", "mobile-crane-setup", "MOBILE CRANE SETUP", "Put the crane on the ground the chart requires.", {
    ...
    scope: "Mobile cranes and boom trucks 1415 operators are dispatched onto. Not tower erection. Not a substitute for the manufacturer’s setup.",
  ...
  swp("1415-SWP-002", "crane-pre-use-inspection", "CRANE PRE-USE INSPECTION", "Each shift, this machine, this configuration.", {
    purpose: "Find defects that affect lifting before the crane comes on load.",
    scope: "Every 1415 operator, every shift, on the crane they will run. Done as the manufacturer, the named 14.2 standard, and Part 14 require.",
    ...
    equipment: ["Manufacturer inspection list", "This SWP", "Inspection form 1415-FRM-002"],
    procedure: [
      ...
      { n: "05", title: "RECORD", body: "Complete the inspection record. Defects that affect lifting: crane down, supervisor and 1415 told." },
    ...
    documentation: ["1415-FRM-002", "Machine log if the site requires it"],
  }),
  swp("1415-SWP-003", "crane-operation", "CRANE OPERATION", "The chart is the law of the machine.", {
    purpose: "Operate the crane to the chart, with a crew you can hear, on a lift you can account for.",
    scope: "Mobile and tower operations 1415 operators are dispatched to perform. Personnel lifts only where legally permitted and engineered.",
  ...
  swp("1415-SWP-004", "crane-shutdown", "CRANE SHUTDOWN", "Leave the machine the way the manufacturer allows you to leave it.", {
    ...
    procedure: [
      ...
      { n: "05", title: "HAND OVER", body: "Defects, remaining fuel, weather, and the next lift — written or spoken to the next operator and to 1415 if the dispatch ends." },
    ],
  ...
  swp("1415-SWP-005", "crane-communication", "CRANE COMMUNICATION", "If the operator cannot hear or see the signal, the crane does not move.", {
    purpose: "Make communication a control, not a courtesy.",
    scope: "All 1415 lifts. Hands, radio, or both. Dedicated systems where Part 14 requires them.",
  ...
  swp("1415-SWP-006", "radio-communication", "RADIO COMMUNICATION", "The lift channel is for the lift.", {
    purpose: "Use radios so the operator gets one clear instruction and a hard STOP.",
    scope: "Any 1415 lift using radios, including blind lifts and tower operations.",
  ...
  swp("1415-SWP-007", "standard-hand-signals", "STANDARD HAND SIGNALS", "Standard signals. Not a private dialect.", {
    purpose: "Use the hand signals the crew agreed, the ones the Board authorizes, so the operator is not translating.",
    scope: "1415 lifts using hand signals. Combined with radio on blind or noisy lifts as briefed.",
  ...
  swp("1415-SWP-008", "blind-lifts", "BLIND LIFTS", "Someone who can see owns the voice. The operator does not guess.", {
  ...
  swp("1415-SWP-009", "rigging-inspection", "RIGGING INSPECTION", "The gear is the truth. The guess is the hazard.", {
    purpose: "Keep failed slings and hardware off the hook.",
    scope: "Every sling, shackle, hook, ring, spreader and below-the-hook device 1415 personnel will load. Part 15 and ASME B30.9 as named.",
    ...
    equipment: ["The gear", "Rejection criteria", "Out-of-service tags", "1415-FRM-003"],
    procedure: [
      ...
      { n: "05", title: "REMOVE OR USE", body: "Fail: tag, isolate, report on 1415-RPT-004. Do not leave failed gear on the pile." },
    ],
    ...
    documentation: ["1415-FRM-003", "Damaged rigging report if it fails"],
  }),
  swp("1415-SWP-010", "sling-selection", "SLING SELECTION", "The hitch chooses the sling. The leftover in the truck does not.", {
    purpose: "Pick a sling that can take the tension at this angle, in this hitch, on this edge, in this environment.",
    scope: "Wire rope, chain and synthetic slings used by 1415 riggers.",
    ...
    procedure: [
      ...
      { n: "03", title: "ANGLE", body: "θ from the horizontal. Tension = share / sin θ for a two-leg bridle. Below 30° is not a 1415 hitch unless an engineer owns it." },
  ...
  swp("1415-SWP-011", "slinging-loads", "SLINGING LOADS", "Connect the hitch as planned. Test it an inch off the ground.", {
    purpose: "Put the sling on the load so the tension goes where you calculated.",
    scope: "Making hitches on construction and industrial lifts 1415 rigs.",
    ...
    procedure: [
      ...
      { n: "02", title: "POINTS", body: "Designed lifting points. If none, the method is engineered or it is not a 1415 hitch." },
  ...
  swp("1415-SWP-012", "shackles", "SHACKLES", "The right shackle, the right pin, the right way around.", {
    purpose: "Use shackles within WLL, with the pin that belongs to them, in the orientation they were made for.",
    scope: "Anchor, chain and other shackles used in 1415 rigging.",
  ...
  swp("1415-SWP-013", "hooks", "HOOKS", "Latch works. Throat not opened. Tip not loaded.", {
    purpose: "Keep hooks in service only when they can hold the hitch they are asked to hold.",
    scope: "Crane hooks and rigging hooks 1415 personnel use.",
  ...
  swp("1415-SWP-014", "rigging-hardware", "RIGGING HARDWARE", "Rated, matched, inspected. No mystery steel.", {
    purpose: "Keep rings, links, turnbuckles, eyebolts, beam clamps and below-the-hook fittings inside their ratings.",
    scope: "Hardware other than slings, shackles and hooks used in 1415 hitches.",
  ...
  swp("1415-SWP-015", "load-control", "LOAD CONTROL", "The load goes where the plan said. Not where it drifted.", {
    purpose: "Control rotation, swing and travel so people and plant are not in the path.",
    scope: "All 1415 lifts once the load is on the hook.",
  ...
  swp("1415-SWP-016", "tag-lines", "TAG LINES", "Lines control rotation. Bodies do not.", {
    purpose: "Use tag lines so the load does not spin into people, steel or the crane.",
    scope: "1415 lifts that require rotational control.",
  ...
  swp("1415-SWP-017", "suspended-loads", "SUSPENDED LOADS", "If it is in the air, the zone is alive.", {
    purpose: "Keep people out from under a load and keep loads from hanging unattended.",
    scope: "Any time a load is off the ground on a 1415 lift.",
  ...
  swp("1415-SWP-018", "working-near-powerlines", "WORKING NEAR POWERLINES", "Assume they are live. MAD is a wall. Table 19-1A.", {
    ...
    scope: "Any 1415 lift where overhead or buried electrical lines exist, or might exist. BC Hydro system or any other utility — the same table. Buried: look down, locate, do not assume the pad is empty.",
    ...
    equipment: ["Spotter", "Range / zone limiting if fitted and used", "1415-FRM-037", "Coded 30M33 if MAD cannot be held"],
    procedure: [
    ...
    emergency:
      "Do not touch the crane or the load. People back 10 m — 33 m if it is transmission or a manhole. Call 911 and BC Hydro. Operator stays on unless fire or shock. 1415 notified immediately.",
    documentation: ["FLHA", "1415-FRM-037", "Coded 30M33 if issued", "This SWP number and revision"],
    references: MAD_REFS,
    links: [
      { href: "/safety/jha/working-near-powerlines", label: "JHA — WORKING NEAR POWERLINES — 1415-JHA-013 →" },
      { href: "/safety/form/powerline-30m33", label: "POWERLINE RECORD — 1415-FRM-037 →" },
      ...MAD_LINKS,
    ],
    tables: MAD_TABLES,
  }),
  swp("1415-SWP-019", "critical-lifts", "CRITICAL LIFTS", "Slower brief. Named supervision. Written plan. Ego is not a control.", {
    ...
    equipment: ["1415-FRM-007", "Radios", "The crane and rigging in the plan"],
    procedure: [
    ...
    documentation: [
      ...
      "1415-FRM-009",
      "SJP if required",
      "Flytables: 1415-SWP-028 and 1415-SJP-001",
      "Loading platforms: 1415-SWP-030 and 1415-SJP-003",
    ],
  }),
  swp("1415-SWP-020", "lift-planning", "LIFT PLANNING", "Weight, COG, chart, path, people, abort — before the hook.", {
    ...
    equipment: ["1415-FRM-006", "Drawings and shipping data", "Chart"],
    procedure: [
    ...
    documentation: ["1415-FRM-006", "FLHA", "Rigging plan if used"],
  }),
  swp("1415-SWP-021", "outrigger-setup", "OUTRIGGER SETUP", "Fully extended unless the chart for short-rig is in the cab and in use.", {
  ...
  swp("1415-SWP-022", "ground-conditions", "GROUND CONDITIONS", "If the ground cannot hold the crane, it is not a crane job yet.", {
  ...
  swp("1415-SWP-023", "weather-and-wind", "WEATHER AND WIND", "Thunder is the stop. The lower wind number wins. Do not count to 30.", {
    ...
    scope: "All 1415 crane and rigging operations outdoors, and indoors where wind through a bay matters. Tower: 14.92 and 14.93 on top of the manufacturer. Electrical earthing and lightning-protection hardware are the owner’s Technical Safety BC electrical work — not this SWP.",
    competency: [
    ...
    procedure: [
      ...
      },
      {
        ...
        body: "Treat it as a misadventure (14.16.1). Crane down. Professional engineer inspects and certifies before anyone hooks a load. Electrical installation is the owner — Technical Safety BC Electrical Safety Regulation if the supply or earthing took the hit. 1415 does not restart to see if the LMI still works.",
      },
      {
        n: "06",
        title: "STOP",
    ...
    emergency:
      "Thunder during a lift: land if it can be done without a second incident. People off. Shelter. Do not gather under the crane. First aid if anyone is hit — lightning victims carry no charge. 911. Notify the site and 1415.",
    ...
    links: [
      { href: "/safety/jha/weather-and-wind", label: "JHA — WEATHER AND WIND — 1415-JHA-015 →" },
      ...LIGHTNING_LINKS,
    ],
  }),
  swp("1415-SWP-024", "crane-emergency-procedures", "CRANE EMERGENCY PROCEDURES", "People first. Then the machine. Then the story.", {
    purpose: "Give the crew one sequence when the crane, the load or a person is in trouble.",
    scope: "Incidents during 1415 crane operations: overload alarms, function failure, contact, fire, medical, overturn developing.",
    ...
    controls: ["Stop", "Safe condition if possible", "Keep people back", "Call for help", "Notify 1415"],
    ...
    procedure: [
      ...
      { n: "05", title: "CALL AND HOLD", body: "Site emergency method. Utility if lines. 1415. Scene held for investigation." },
    ],
    ...
    documentation: ["Incident report 1415-FRM-010", "Machine log"],
  }),
  swp("1415-SWP-025", "removal-of-damaged-rigging", "REMOVAL OF DAMAGED RIGGING FROM SERVICE", "Tag it. Isolate it. Tell someone. No one more lift.", {
    purpose: "Make sure failed gear cannot be picked up by the next rigger.",
    scope: "Any sling or hardware that fails inspection or is damaged in use on a 1415 dispatch.",
    ...
    controls: ["Immediate removal", "Physical isolation", "Tag", "Report 1415-RPT-004"],
    ...
    procedure: [
      ...
      { n: "04", title: "REPORT", body: "1415-RPT-004 the same shift. Site if it is their gear." },
      { n: "05", title: "DO NOT REPAIR IN THE FIELD", body: "No wrapping tape as a WLL. No welding a hook. Destroy or return through 1415 or the owner." },
    ],
    ...
    documentation: ["1415-FRM-003", "1415-RPT-004"],
  }),
  swp("1415-SWP-026", "lockout", "LOCKOUT / ISOLATION", "If you are not operating it, the energy is isolated. Part 10.", {
    ...
    scope: "1415 personnel on a crane they are not operating: maintenance they are assigned, climbing past the cab for inspection, rescue, or working on 1415-controlled tools and vehicles. Not a substitute for the owner’s lockout procedure on that crane. Not tower jumping — see 1415-SWP-027.",
    ...
    procedure: [
      ...
      { n: "02", title: "OWNER’S PROCEDURE", body: "Use the lockout written for this crane when it exists. 1415 does not override a stricter owner procedure." },
    ...
    documentation: ["Owner lockout for this serial", "1415-FRM-002 / 027 if the machine was down for a defect"],
    emergency: "If energy appears during the work: get clear. Re-isolate. Do not finish the job on a live machine.",
  }),
  swp("1415-SWP-027", "tower-erection-climbing", "TOWER ERECTION, CLIMBING AND DISMANTLING", "Not a routine operator dispatch. Qualified supervisor. Notice of Project. 14.73.2.", {
    purpose: "Stop 1415 from treating jumping a tower like running a shift. If this is the work, it is planned as this work.",
    ...
    competency: ["Work under a qualified supervisor as 14.73.2 and 14.73.3 require. 1415 does not send an operator to jump a crane because they have a tower ticket."],
    ...
    controls: ["This is a planned operation or it is not 1415 work", "Notice of Project at least two weeks before, as 14.73.3 requires", "Qualified supervisor", "Manufacturer sequence", "Exclusion zone", "Lockout"],
    equipment: ["This crane’s erection / climbing manual", "The climbing frame for this serial", "1415-SWP-026"],
    procedure: [
      ...
      { n: "05", title: "ISOLATE WHEN REQUIRED", body: "Lockout / isolation when anyone is in the machine for this work. 1415-SWP-026." },
  ...
  swp("1415-SWP-028", "flytable-cycling", "FLYTABLE CYCLING", "Drop, roll, fly, land. Critical lift. The drawing and the OEM cycle win.", {
    purpose: "Give the 1415 crew one method for flying a table-form from floor to floor: designated pick points, no pulling the table out, confirmation-loop radios, holds. Formwork carpentry stays with the host.",
    scope: "1415 operator, rigger and signalperson on a flytable / flyform cycle. Not a how-to for dropping jacks, rolling dollies or landing props. Those belong to the manufacturer cycle and the site-specific engineered drawing. Corner and nontypical tables: 1415-SWP-029 on top of this procedure.",
    ...
    equipment: [
      ...
      "Tag lines",
      "1415-FRM-007, 1415-FRM-009, 1415-FRM-052",
    ],
    procedure: [
      {
        n: "01",
        title: "GATE",
        body: "Engineered drawing for this table ID and this floor. Manufacturer cycle at the lift. Weight and COG known (14.36). Pick points and sling lengths as the drawing. Wind — the lower of crane, manufacturer, this SJP. 1415-SJP-001 / FRM-052 filled. Critical lift plan. Radios tested, confirmation loop, both floors. Pre-lift meeting immediately before this cycle. Corner or nontypical: 1415-SWP-029 and that plan. If any of that is missing, the hook does not take the table.",
      },
      {
        n: "02",
        title: "DROP",
        body: "Formwork drops the table per the manufacturer and the drawing — jacks, lowering devices, reshores. 1415 hook is not a substitute for lowering jacks. Confirm the table is free of the slab, pins and spindles as the OEM, nothing snagged. Crane on standby. Do not take load to strip.",
      },
      {
        n: "03",
    ...
    emergency:
      "Table hung up, rolling toward the edge, dropped object, person in the zone, wind pickup, lost radio — stop. Land if it can be done without a second incident. Do not pull. First aid. Notify the site and 1415. Hold the scene.",
    documentation: [
      "1415-SJP-001 / FRM-052 for this cycle",
      "1415-FRM-007 critical lift plan",
      "1415-FRM-009 pre-lift meeting",
    ...
    links: [
      { href: "/safety/sjp/flytable-cycle", label: "SJP — THIS CYCLE — 1415-SJP-001 →" },
      { href: "/safety/jha/flytable-cycling", label: "JHA — FLYTABLE CYCLING — 1415-JHA-011 →" },
      ...FLYTABLE_LINKS,
    ],
  }),
  swp("1415-SWP-029", "corner-nontypical-flytables", "CORNER AND NONTIPICAL FLYTABLES", "Awkward shape. Reduced stability. Not the typical SJP.", {
    ...
    scope: "1415 crew when the table is a corner, infill, reduced-width, or any table the drawing or the engineer marks nontypical. Do 1415-SWP-028 as well. This SWP does not replace it.",
    responsibilities: FLYTABLE_ROLES,
    competency: [
      "Same as 1415-SWP-028",
    ...
    equipment: ["1415-SWP-028 equipment", "The special handling plan for this table", "1415-SJP-002 / FRM-052 marked nontypical"],
    procedure: [
      {
        n: "01",
        title: "NAME IT",
      ...
      },
      {
        ...
        body: "Do 1415-SWP-028 on top of that plan. Gate, drop, roll, attach, fly, land. The crane still does not pull the table out.",
      },
      {
        n: "04",
        title: "STOP",
    ...
    emergency:
      "Same as 1415-SWP-028. A nontypical table that starts to spin is a stop, not a recovery with more hoist.",
    documentation: [
      "1415-SJP-002 / FRM-052 marked nontypical",
      "Special handling plan attached",
      "1415-SWP-028 documentation",
    ],
    references: FLYTABLE_REFS,
    links: [
      { href: "/safety/sjp/corner-nontypical-flytable", label: "SJP — CORNER / NONTIPICAL — 1415-SJP-002 →" },
      { href: "/safety/jha/corner-nontypical-flytables", label: "JHA — CORNER AND NONTIPICAL — 1415-JHA-012 →" },
      ...FLYTABLE_LINKS,
    ],
  }),
  swp("1415-SWP-030", "loading-platform-reposition", "LOADING PLATFORM INSTALL AND REPOSITION", "Empty. Four designated points. Props released. Then fly. Critical lift. The OEM user information wins.", {
    purpose: "Give the 1415 crew one method for installing, repositioning or striking a cantilever loading platform by crane. Rails, props, clamps and daily extend / retract stay with the host.",
    scope: "1415 operator, rigger and signalperson on a Doka, SuperDeck, CantiDeck, PERI RCS MP, DOC or other OEM loading platform. Not a how-to for propping, clamping, through-slab anchors, or rolling a SuperDeck in. Those belong to the manufacturer and the host. Landing materials onto a deck already in service is a separate lift — this SWP still names the WLL rule.",
    ...
    equipment: [
      ...
      "Tag lines",
      "Radios on the named channel",
      "1415-FRM-007, 1415-FRM-009, 1415-FRM-053",
    ],
    procedure: [
      {
        n: "01",
        title: "GATE",
        body: "OEM user information for this serial at the lift. Type plate. Engineered drawing if the site has one. Dead weight known (14.36) — empty, plus rigging. Not the service WLL. Pick points only as the OEM names. Wind — the lower of crane, manufacturer, this SJP. Doka cites 72 km/h while repositioning; a lower number still wins. 1415-SJP-003 / FRM-053 filled. Critical lift plan. Radios tested. Pre-lift meeting immediately before this lift. Retractable or fixed — said. If any of that is missing, the hook does not take the deck.",
      },
      {
        n: "02",
        title: "HITCH",
      ...
      },
      {
        n: "04",
        title: "RELEASE",
        body: "Host releases props, clamps or through-slab anchors to the OEM. 1415 does not invent that sequence. CantiDeck: do not lift until the props are released. Take a little load, confirm free, then hoist. Do not strip with the crane.",
      },
      {
        n: "05",
        title: "FLY",
      ...
      },
      {
        n: "08",
        title: "RETRACTABLE",
        body: "SuperDeck, CantiDeck Super Roller, DOC: daily extend and retract is host. Preston: no crane licence to roll it. 1415 is not hooked while it moves as a drawer. Install, reposition and strike stay this SWP — empty, four points, props released.",
      },
    ],
    prohibited: [
    ...
    emergency:
      "Deck hung up, dumped at the edge, dropped object, person in the zone, wind pickup, lost radio — stop. Land if it can be done without a second incident. Do not pull. First aid. Notify the site and 1415. Hold the scene.",
    documentation: [
      "1415-SJP-003 / FRM-053 for this deck",
      "1415-FRM-007 critical lift plan",
      "1415-FRM-009 pre-lift meeting",
    ...
    links: [
      { href: "/safety/sjp/loading-platform", label: "SJP — THIS DECK — 1415-SJP-003 →" },
