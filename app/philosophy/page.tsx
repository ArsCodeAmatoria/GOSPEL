...
export const metadata: Metadata = {
  title: "Philosophy",
  description:
    "No bullshit. Just good people doing heavy work. GOSPEL's operating philosophy for crane and rigging crews.",
};
  ...
  return (
    <div>
      ...
      <div className="split wrap top" style={{ paddingBottom: "4rem" }}>
        <p className="lede-lg">
          GOSPEL is a complete crane operations and rigging company. Operators,
        ...
        <p className="lede">
          ...
          If GOSPEL says it will show up, GOSPEL shows up.
        </p>
      </div>
